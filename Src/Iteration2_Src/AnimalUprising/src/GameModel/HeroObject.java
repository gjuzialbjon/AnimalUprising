...
public class HeroObject extends CharacterObject implements Ally {
	...
	private void getInput()
	{
		...
		if(gameManager.getInputManager().summon4)
		{
			summonAlly(4);
		}
		if(gameManager.getInputManager().skill1)
		{
			castSkill(1);
		}
		if(gameManager.getInputManager().skill2)
		{
			castSkill(2);
		}
		if(gameManager.getInputManager().skill3)
		{
			castSkill(3);
		}
		if(gameManager.getInputManager().skill4)
		{
			castSkill(4);
		}
	}
